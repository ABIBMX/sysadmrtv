<?php
	...
	define('DB_USUARIO','root'); // Nombre del usuario de la base de datos en la mayoria de los casos no se cambiar� este valor.
	define('DB_PASSWORD',''); // contrase�a de la base de datos.	
	define('RUTA', dirname(__FILE__),'/');
	define('ENCABEZADO','TUVISION - Sistema de Administracion');
	define('PIE_PAGINA','<b>www.tuvision.mx</b>');
?>
