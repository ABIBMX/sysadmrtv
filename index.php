				...
				switch(modulo.innerHTML)
				{
					...
					case '5':
						...
						enviar_filtro.onclick = function(){
							...
							var input_tipo_servicio =  document.createElement("input");
							var filtro =  document.createElement("input");
							...
							input_tipo_servicio.type = "hidden";
							filtro.type = "hidden";
							...
							input_tipo_servicio.name = "tservicio";
							filtro.name= "aplicar_filtro";
							...
							input_tipo_servicio.value = document.getElementById("tservicio").value;
							...
							form.appendChild(input_tipo_servicio);
							form.appendChild(filtro);
