...
<?php
		...
		$query = "select f.id_factura,
						 ...
						 f.no_factura,
						 c.nombre 
						 from f_facturas f, f_cat_proveedor p, f_status_factura s, f_cat_tipo_factura tf, f_cat_tipo_moneda tm, f_canales c 
						 where c.id_canal = f.id_canal and  tm.id_tipo=f.id_tipo_moneda and tf.id_tipo=f.id_tipo and  p.id_proveedor=f.id_proveedor and f.id_status=s.id_status".$_SESSION['filtro_tuvision_facturas_addquery']." order by f.id_factura desc";
