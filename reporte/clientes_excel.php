...
<?php
		...
		while(list($id,$nombre,$telefono,$sucursal,$estatus,$tipo_status,$tipo_servicio,$tap,$calle,$numero,$referencia,$fecha_activacion,$tarifa,$saldo_actual,$winbox,$mac_winbox,$plan_datos,$ip_asignada,$fecha_urs,$estatus_urs,$utipo_servicio,$onu_recuperada,$ultima_inscripcion) = mysqli_fetch_array($consulta)){
			if($contador%2==0)
				$color = "";
			else
			...
			echo "<tr $color>";
				...
				echo "<td align='left'>" . str_replace(' ', '', $telefono) . "</td>";
				...
				echo "<td align='left'>".$onu_recuperada."</td>";
