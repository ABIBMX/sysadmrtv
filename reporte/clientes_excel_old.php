...
<?php
		...
		while(list($id,$nombre,$telefono,$sucursal,$estatus,$tipo_status,$tipo_servicio,$fecha_contrato,$fecha_activacion,$tap,$calle,$numero,$referencia,$saldo_actual,$winbox,$mac_winbox,$plan_datos,$ip_asignada,$fecha_urs,$estatus_urs,$utipo_servicio) = mysqli_fetch_array($consulta)){
			if($contador%2==0)
				$color = "";
			else
