...
a)	Que reconoce las facultades de la Secretaria de Telecomunicaciones y Transportes y de la Comisión Federal de Telecomunicaciones para verificar y requerir información, las cuales se precisan en la condición que a continuación se menciona.
...
";
		...
		$pdf->ezText(utf8_decode("\n".$texto),12,array('justification'=>'full'));
		
		
		$y = 140;
		$pdf->addTextWrap (30,$y,150,12,utf8_decode("<b>NÚMERO DE CONTRATO:</b>"),'left');
		$pdf->addTextWrap (175,$y,420,12,$num_contrato,'left');
		$pdf->addTextWrap (30,$y-15,150,12,utf8_decode("<b>FECHA DEL CONTRATO:</b>"),'left');
		$pdf->addTextWrap (175,$y-15,420,12,$fecha_contrato,'left');
		$pdf->addTextWrap (30,$y-30,150,12,utf8_decode("<b>NÚMERO DEL CLIENTE:</b>"),'left');
		$pdf->addTextWrap (175,$y-30,420,12,$id_cliente,'left');
		$pdf->addTextWrap (30,$y-45,160,12,utf8_decode("<b>NOMBRE DEL SUSCRIPTOR:</b>"),'left');
		$pdf->addTextWrap (195,$y-45,420,12,$cliente,'left');
		$pdf->addTextWrap (30,$y-60,180,12,utf8_decode("<b>DOMICILIO DEL SUSCRIPTOR:</b>"),'left');
		//$pdf->addTextWrap (215,$y-60,420,12,$direccion,'left');
		$pdf->ezText(utf8_decode("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t".$direccion),12,array('justification'=>'full'));
