	...
	<tr>    
    	<td align="right">
        	<table border="0" width="100%" cellpadding="0" cellspacing="0" >
                ...
                <td align="left" background="imagenes/module_center.png" height="80" valign="middle" class="titulo"><b>&nbsp;&nbsp;AGREGAR TIPO DE SERVICIO</b></td>
				...
				<tr>
					<td>
						...
						<table style="color:#000000" cellpadding="5">
                        	<tr>
                        	  <td>Tipo de Servicio</td><td><input name="nombre" style="width:200px;font-size:12px;" type="text" maxlength="255" /></td></tr>                                                            
						</table>
