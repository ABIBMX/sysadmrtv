...
<table border="0px"  width="100%" style="color:#000000;font-size:12px">
    ...
    <?php
		...
		if(isset($id))
		{
			...
			referencia,
			comision_id_egreso
			from depositos d where id_deposito='".addslashes($id)."' and id_empleado_deposita in (select id_empleado from empleados  where id_sucursal='".$_SESSION['tuvision_id_sucursal']."')";
			...
			referencia,
			id_tipo_egreso
			from egresos e where id_egreso='".addslashes($registro[8])."' and id_empleado in (select id_empleado from empleados  where id_sucursal='".$_SESSION['tuvision_id_sucursal']."')";
					...
					<td>
						...
						<table style="color:#000000" cellpadding="5">
							...
							if($registro2[10]==10){
								?>
                              <tr>
                        	  <td>A Quien se Reembolsara:</td><td>
                              <?php
                              echo $registro2[4];
								?>
                              ...
                              <tr>
                        	  <td>N&uacute;mero de autorizaci&oacute;n &oacute; transacci&oacute;n:</td><td>
                              <?php
                              echo $registro2[9];
								?>
                              </td></tr>                                                            					
