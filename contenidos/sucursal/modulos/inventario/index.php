		...
		if(isset($_POST['accion']))
		{
			switch($_POST['accion'])
			{
				case 'editar':
					...
					$query = "update inventario set cantidad='".addslashes(strtoupper($_POST['cantidad']))."', id_equipo_inventario='".addslashes($_POST['equipo'])."'  where id_sucursal='".$_SESSION['tuvision_id_sucursal']."' and  id_equipo_inventario='".addslashes($_POST['e'])."'";
			...
			<table class="datagrid" width="100%" border="0" cellspacing="0">
				...
				<?php
					if(isset($_POST['aplicar_filtro']))
					{
						...
						$query = "select cei.descripcion,i.id_sucursal, i.cantidad, i.id_equipo_inventario from inventario i, cat_equipos_inventario cei where cei.id_equipo_inventario=i.id_equipo_inventario ".$add_query." and i.id_sucursal='".$_SESSION['tuvision_id_sucursal']."' order by id_sucursal asc, i.id_equipo_inventario asc";
						...
						while($registro=mysqli_fetch_array($tabla))
						{
							...
							?>
								<tr class="tabla_row">
									<td><a href="index.php?menu=22&accion=editar&e=<?php echo $registro[3] ?>"><?php echo $registro[0]; ?></a></td>
									<td><a href="index.php?menu=22&accion=editar&e=<?php echo $registro[3] ?>"><?php echo $registro[1]; ?></a></td>
									<td><a href="index.php?menu=22&accion=editar&e=<?php echo $registro[3] ?>"><?php echo $registro[2]; ?></a></td>                                
									<td align="center"><input type="checkbox" name="<?php echo $registro[3];  ?>" /></td>
								</tr>
							<?php
						}
						if(!$bandera)
