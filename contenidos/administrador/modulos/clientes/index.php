...
<table border="0px" width="100%" style="color:#000000;font-size:12px">
	...
	if (isset($_POST['accion'])) {
		switch ($_POST['accion']) {
			case 'editar':
				$_POST['sucursal'] = addslashes($_POST['sucursal']);
				...
				$_POST['tipo_contratacion'] = addslashes(strtoupper($_POST['tipo_contratacion']));
	...
	?>
			...
			case 'agregar':
				...
				$siguiente_subclave_query = "select MAX(SUBSTR(id_cliente,4))+ 1 AS SIGUIENTE from clientes where id_sucursal='" . $_POST['sucursal'] . "'";
				...
				$clave = $_POST['sucursal'] . $subclave_generada[0];

				$query = "insert into clientes (id_cliente,id_sucursal, id_tipo_status, id_calle, nombre, apellido_paterno, apellido_materno, numero, tarifa, num_contrato, fecha_contrato, referencia_casa,fecha_registro,id_tap,colonia,numero_interior,cp,telefono,rfc,correo ) values ('" . $clave . "','" . $_POST['sucursal'] . "',11,'" . $_POST['calle'] . "','" . $_POST['nombre'] . "','" . $_POST['apellido_paterno'] . "','" . $_POST['apellido_materno'] . "','" . $_POST['numero'] . "'," . $_POST['tarifa'] . ",'" . $_POST['num_contrato'] . "','" . $_POST['fecha_contrato'] . "','" . $_POST['referencia_casa'] . "','" . date('Y-m-d') . "'," . $tap . ",'" . $_POST['colonia'] . "','" . $_POST['numero_interior'] . "','" . $_POST['cp'] . "','" . $_POST['telefono'] . "','" . $_POST['rfc'] . "','" . $_POST['email'] . "')";
