<script language="javascript" type="text/javascript">
	...
	function guardar() {
		...
		if (cadena == "") {
			...
			// alert(cliente + "&" + no_olt + "&" + no_caja + "&" + no_pon + "&" + marca_onu + "&" + modelo_onu + "&" + serie + "&" + mac_address + "&" + encapsulamiento + "&" + registro_winbox + "&" + mac_winbox + "&" + plan_datos + "&" + vlan + "&" + ip_instalacion + "&" + resguardo + "&" + snap + "&" + psdivisor + "&" + plldomicilio);
								...
								<form name="formulario2" method="post" onsubmit="return false;" action="">
									<table style="color:#000000" cellpadding="5">
										...
										<tr>
											...
											<td><button onclick='guardar()' style="background-color:#88DC65; width: 150px">Guardar Información</button></td>
				...
				<td colspan="3">
					<form name="formulario4" method="post" onsubmit="return false;" action="">
						<table class="datagrid" width="100%" border="0" cellspacing="0">
							...
							<tr>
								<td colspan="20" height="3px" class="separador"></td>
							</tr>
						</table>
					</form>
				</td>
