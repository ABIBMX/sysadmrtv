					...
					<td>						
						...
						<table style="color:#000000" cellpadding="5">                        	
                            <tr>
                            	<td>Sucursal</td>
                                <td>
                                	<select name="sucursal" id="sucursal" onchange="cargarCalle(this.value);cargarTap(this.value);" style="width:300px; font-size:12px;">
										...
										<?php
											...
											while($registro_combo = mysqli_fetch_array($tabla_t_u))
											{
												if($registro[1]==$registro_combo[0])
													echo "<option value=\"$registro_combo[0]\" selected=\"selected\">$registro_combo[0] - $registro_combo[1]</option>";
												else
													echo "<option value=\"$registro_combo[0]\">$registro_combo[0] - $registro_combo[1]</option>";
											}
                                        ?>
                                    </select>
                                </td>
                            </tr>
                            <tr><td>Nombre</td><td><input name="nombre" style="width:300px;font-size:12px;" type="text" value="<?php echo $registro[4]; ?>" maxlength="255" /></td></tr>
                            <tr><td>Apellido Paterno</td><td><input name="apellido_paterno" style="width:300px;font-size:12px;" value="<?php echo $registro[5]; ?>" type="text" maxlength="255" /></td></tr>
                            <tr><td>Apellido Materno</td><td><input name="apellido_materno" style="width:300px;font-size:12px;" value="<?php echo $registro[6]; ?>" type="text" maxlength="255" /></td></tr>
                            <tr><td>Telefono</td><td><input name="telefono" style="width:300px;font-size:12px;" type="text" maxlength="18" value="<?php echo $registro[18]; ?>"/></td></tr>
                            <tr><td>R.F.C.</td><td><input name="rfc" style="width:300px;font-size:12px;" type="text"  value="<?php echo $registro[19]; ?>" maxlength="18" /></td></tr>
                            <tr><td>EMAIL</td><td><input name="email" style="width:300px;font-size:12px;" value="<?php echo $registro[20]; ?>" type="text" maxlength="255" /></td></tr>
                            ...
                            <tr><td>Colonia</td><td><input name="colonia" style="width:300px;font-size:12px;" type="text" maxlength="150" value="<?php echo $registro[15]; ?>"/></td></tr>
                            <tr><td>Numero Exterior</td><td><input name="numero" style="width:50px;font-size:12px;" value="<?php echo $registro[7]; ?>" type="text" maxlength="12" /></td></tr> 
                             <tr><td>Numero Interior</td><td><input name="numero_interior" style="width:50px;font-size:12px;" type="text" maxlength="11" value="<?php echo $registro[16]; ?>" /></td></tr> 
                             <tr><td>CP</td><td><input name="cp" style="width:50px;font-size:12px;" type="text" maxlength="8" value="<?php echo $registro[17]; ?>"/></td></tr> 
                            <tr><td>Referencia de la Casa</td><td><input name="referencia_casa" style="width:300px;font-size:12px;"  value="<?php echo $registro[12]; ?>" type="text" maxlength="255" /></td></tr>
                            <tr>
                            	<td>ID TAP</td>
                                <td>
                                	<div id="div_tap">
                            ...
                            <tr><td colspan="2"><hr /></td></tr>
                            <tr><td>Tarifa $</td><td><input name="tarifa" onchange="solo_numeros_decimales(this)" onkeyup="solo_numeros_decimales(this)" value="<?php echo $registro[8]; ?>" style="width:50px;font-size:12px;" type="text" maxlength="7" /></td></tr> 
                             <tr><td>No. Contrato</td><td><input name="num_contrato" onchange="solo_numeros(this)" onkeyup="solo_numeros(this)" value="<?php echo $registro[10]; ?>" style="width:50px;font-size:12px;" type="text" maxlength="10" /></td></tr>                     
                            <tr><td>Fecha Contrato</td><td><input name="fecha_contrato" id="fecha_contrato" value="<?php echo $registro[11]; ?>"  style="width:90px;font-size:12px; background-image:url(calendario/imgs/icon_minicalendar.gif); background-position:right center; background-repeat:no-repeat;" type="text" maxlength="10" readonly /></td></tr>                        
                        </table>
