...
<script language="javascript" type="text/javascript">
	...
	function guardar()
	{
		...
		if(document.formulario.nombre.value=='')
			cadena+= "\n* Debe asignar un tipo de egreso.";
...
<table border="0px"  width="100%" style="color:#000000;font-size:12px">
	<tr>    
    	<td align="right">
        	<table border="0" width="100%" cellpadding="0" cellspacing="0" >
                ...
                <td align="left" background="imagenes/module_center.png" height="80" valign="middle" class="titulo"><b>&nbsp;&nbsp;EDITAR TIPO DE EGRESO&nbsp;</b></td>
                <td align="right" background="imagenes/module_center.png" height="80" >
                    <button class="boton2" id="guardar" onclick="guardar()" ><img src="imagenes/guardar.png" /><br/>Guardar</button>
					<button class="boton2" onclick="location.href='index.php?menu=6'"><img src="imagenes/cancelar.png" /><br />Cancelar</button>
                </td>
    ...
    <?php
		...
		if(isset($id))
		{
			...
			$query = "select * from cat_tipo_egreso where id_tipo_egreso='".addslashes($id)."'";
	...
	<tr>
		<td colspan="3">
			<table class="datagrid" width="100%" border="0" cellspacing="0">
				...
				<tr>
					<td>						
						<form name="formulario" method="post" onsubmit="return false;"  action="index.php?menu=6">
						<table style="color:#000000" cellpadding="5">
                        	<tr>
                        	  <td>Tipo de Egreso</td><td><input name="nombre" style="width:200px" type="text" maxlength="255" value="<?php echo $registro[1]; ?>" /></td></tr>                        </table>
