		...
		<td align="right">
			<table border="0" width="100%" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td align="left" background="imagenes/module_center.png" height="80" valign="middle" class="titulo"><b>&nbsp;&nbsp;AGREGAR PROVEEDOR</b></td>
					...
					<td>
						<form name="formulario" method="post" onsubmit="return false;" action="index.php?menu=34">
							<table style="color:#000000" cellpadding="5">
								...
								<tr>
									<td>Nombre:</td>
									<td><input name="nombre" style="width:200px;font-size:12px;" type="text" maxlength="255" /></td>
								</tr>
								<tr>
