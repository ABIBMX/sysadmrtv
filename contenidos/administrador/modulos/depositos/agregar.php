...
<script language="javascript" type="text/javascript">
	...
	function guardar()
	{
		...
		if(document.formulario.sucursal_dep.value=='null')
			cadena+= "\n* Debe ingresar una sucursal del deposito.";
		...
		if(document.formulario.sucursal.value=='null')
			cadena+= "\n* Debe seleccionar una sucursal donde se genero el egreso";
					...
					<td>
						...
						<table style="color:#000000" cellpadding="5">
                        	<tr>
                              ...
                              <tr>
                              <td>Sucursal:</td><td>
                              <select name="sucursal_dep" onchange="_Ajax('autorizo_dep',this.value);" style='width:300px;font-size:12px;'>
                              ...
                              <tr>
                        	  <td>Fecha:</td><td>
                              <input name="fechas" id="fechas"  style="width:90px;font-size:12px; background-image:url(calendario/imgs/icon_minicalendar.gif); background-position:right center; background-repeat:no-repeat;" type="text" maxlength="10" readonly="readonly" onfocus="calendario(this.id);" />
					...
					<td>
						...
						<table style="color:#000000" cellpadding="5">
                        	...
                        	<tr>
                              ...
                              <tr>
                        	  <td>Sucursal:</td><td>
                              <select name="sucursal" onchange="_Ajax_egreso('autorizo',this.value);" style='width:300px;font-size:12px;'>
                              <option value="null">Seleccione una sucursal</option>
                              	<?php
									$query = "select id_sucursal,nombre from sucursales";
									$result = mysqli_query($conexion,$query);
                              ...
                              <tr>
                        	  <td>Referencia de comprobante:</td><td><input name="r_comprobante" style="width:200px;font-size:12px;" type="text" maxlength="255" /></td></tr>                                                            					
...
window.onload = function() {
    cal1 = new dhtmlxCalendarObject('fechas');
