				...
				<tr>
					<td>
						...
						<table style="color:#000000" cellpadding="5">
                            ...
                            <tr><td>ID Tap</td><td><input name="id_tap" style="width:100px;font-size:12px;" value="<?php echo $registro[0]; ?>" type="text" maxlength="20" /></td></tr>
							...
							<tr><td>Poste #</td><td><input  name="poste" style="width:100px;font-size:12px;" type="text" maxlength="15" value ="<?php echo $registro[2]; ?>"/></td></tr>                                          
							<tr><td>Tipo de Poste (CFE/PROPIO/OTRO)</td><td><input  name="tipoposte" style="width:100px;font-size:12px;" type="text" maxlength="15" value ="<?php echo $registro[3]; ?>"/></td></tr>      
							<tr><td>Trayectoria</td><td><input onchange="solo_numeros(this)" onkeyup="solo_numeros(this)" name="trayectoria" style="width:100px;font-size:12px;" type="text" maxlength="15" value ="<?php echo $registro[4]; ?>"/></td></tr>
							<tr><td>Fibra/Coaxial</td><td><input  name="fibracoaxial" style="width:100px;font-size:12px;" type="text" maxlength="255" value ="<?php echo $registro[5]; ?>"/></td></tr>
							<tr><td>Especificacion de cable</td><td><input  name="especificacion" style="width:100px;font-size:12px;" type="text" maxlength="255" value ="<?php echo $registro[6]; ?>"/></td></tr>
							<tr><td>Ingrese KG/KM de fabrica</td><td><input  name="pesofabrica" id="pesofabrica" onchange="calcular();solo_numeros_decimales(this)" style="width:100px;font-size:12px;" type="text" maxlength="15" value ="<?php echo $registro[16]; ?>"/></td></tr>
							<tr><td>Del poste</td><td><input  name="delposte" onchange="solo_numeros(this)" onkeyup="solo_numeros(this)" style="width:100px;font-size:12px;" type="text" maxlength="11" value ="<?php echo $registro[7]; ?>"/></td></tr>
							<tr><td>Al poste</td><td><input  name="alposte" onchange="solo_numeros(this)" onkeyup="solo_numeros(this)" style="width:100px;font-size:12px;" type="text" maxlength="11" value ="<?php echo $registro[8]; ?>"/></td></tr>
							<tr><td>Distancia entre postes</td><td><input  name="distancia" id="distancia" onchange="solo_numeros_decimales(this);calcular()" onkeyup="solo_numeros_decimales(this);calcular()" style="width:100px;font-size:12px;" type="text" maxlength="11" value ="<?php echo $registro[9]; ?>"/></td></tr>
							<tr><td>Peso Kg/Km de trayectoria</td><td><input  name="peso" id="peso"  style="width:100px;font-size:12px;" type="text" maxlength="255" value ="<?php echo $registro[10]; ?>" readonly="readonly"/></td></tr>
							<tr><td>Latitud</td><td><input  name="latitud"  style="width:100px;font-size:12px;" type="text" maxlength="255" value ="<?php echo $registro[11]; ?>"/></td></tr>
							<tr><td>Longitud</td><td><input  name="longitud"  style="width:100px;font-size:12px;" type="text" maxlength="255" value ="<?php echo $registro[12]; ?>"/></td></tr>
							<tr><td>Zona</td><td><input  name="zona"  style="width:100px;font-size:12px;" type="text" maxlength="255" value ="<?php echo $registro[17]; ?>"/></td></tr>
							<tr><td><center>Clientes en TAP</center></td>
							</tr>
							<?php
