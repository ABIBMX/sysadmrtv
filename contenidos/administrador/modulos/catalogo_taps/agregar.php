				...
				<tr>
					<td>
						...
						<table style="color:#000000" cellpadding="5">
							...
							<tr><td>Latitud (UTM)</td><td><input  name="latitud"  style="width:100px;font-size:12px;" type="text" maxlength="255" /></td></tr>
							<tr><td>Longitud (UTM)</td><td><input  name="longitud"  style="width:100px;font-size:12px;" type="text" maxlength="255" /></td></tr>

							<tr><td>Latitud (GRADOS)</td><td><input  name="latitudG"  style="width:100px;font-size:12px;" type="text" maxlength="255" /></td></tr>
							<tr><td>Longitud (GRADOS)</td><td><input  name="longitudG"  style="width:100px;font-size:12px;" type="text" maxlength="255" /></td></tr>
							
							<tr><td>Zona</td><td><input  name="zona"  style="width:100px;font-size:12px;" type="text" maxlength="255" /></td></tr>
						</table>
