	...
	<tr>
		<td colspan="3">
			...
			<table class="datagrid" width="100%" border="0" cellspacing="0">
				<tr><td colspan="16" height="3px" class="separador"></td></tr>
				...
				<?php
					...
					$query = "select t.id_tap,c.nombre,t.poste,t.tipoposte,t.trayectoria,t.fibracoaxial,t.especificacioncable,t.delposte,t.alposte,t.distancia,t.peso,t.latitud,t.longitud,t.id_sucursal,t.zona from tap t,cat_calles c where t.calle=c.id_calle ".$add."order by t.id_sucursal,t.id_tap asc";
