		...
		<td colspan="3">
			<form name="datagrid" method="post">
				<table class="datagrid" width="100%" border="0" cellspacing="0">
					<tr>
						<td colspan="18" height="3px" class="separador"></td>
					</tr>
					...
					$query = "select t.id_tap,c.nombre,t.poste,t.tipoposte,t.trayectoria,t.fibracoaxial,t.especificacioncable,t.delposte,t.alposte,t.distancia,t.peso,t.latitud,t.longitud,t.id_sucursal,t.zona,t.latitudG,t.longitudG from tap t,cat_calles c where t.calle=c.id_calle " . $add . " AND t.eliminado = 0  order by t.id_sucursal,t.id_tap asc";
