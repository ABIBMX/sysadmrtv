					...
					<td width="150px">Sucursal</td><td width="100px" align="right" >Ingresos del D&iacute;a</td><td width="100px" align="right" >Egresos del D&iacute;a</td><td width="100px" align="right" >Depositos del D&iacute;a</td><td width="100px" align="right" >Caja Anterior</td><th width="100px" align="right">Caja Actual</th><td>&nbsp;</td>
						...
						<?php
							...
							while($registro=mysqli_fetch_array($tabla))
							{
								...
								echo "<td align=\"right\">".number_format($caja[0],2, '.', ',')."</td><td align=\"right\">".number_format($caja[1],2, '.', ',')."</td><td align=\"right\">".number_format($caja[2],2, '.', ',')."</td><td align=\"right\">".number_format($caja[3],2, '.', ',')."</td><td align=\"right\"><b>".number_format($caja[4],2, '.', ',')."</b></td><td>&nbsp;</td></tr>";
								
							}
							echo "<tr><td><b>TOTALES:</b></td><td  align=\"right\"><b>".number_format($total_ingresos,2, '.', ',')."</b></td><td  align=\"right\"><b>".number_format($total_egresos,2, '.', ',')."</b></td><td  align=\"right\"><b>".number_format($total_depositos,2, '.', ',')."</b></td><td align='right'>&nbsp;</td><td  align=\"right\"><b>".number_format($total_caja,2, '.', ',')."</b></td></tr>";
                        ?>
			...
			<table class="datagrid" width="100%" border="0" cellspacing="0">
				...
				<?php
					if(isset($_POST['filtro']))
					{
						...
						if($_POST['sucursal']!="-1")
							$add_query .= "  and c.id_sucursal='".addslashes($_POST['sucursal'])."'";
					
				$query = "select c.id_caja, c.id_sucursal, cto.descripcion,c.cantidad, c.caja_anterior, c.caja_actual, c.fecha_operacion, c.hora_operacion, c.concepto, c.id_cliente, c.referencia   from cajas c, cat_tipo_operacion cto where cto.id_tipo_operacion=c.id_tipo_operacion ".$add_query." and fecha_operacion BETWEEN '".addslashes($_POST['desde'])."' and '".addslashes($_POST['hasta'])."' order by c.id_sucursal asc, c.fecha_operacion asc, c.id_caja asc";
