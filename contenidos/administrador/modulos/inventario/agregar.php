	...
	<tr>    
    	<td align="right">
        	<table border="0" width="100%" cellpadding="0" cellspacing="0" >
                ...
                <td align="left" background="imagenes/module_center.png" height="80" valign="middle" class="titulo"><b>&nbsp;&nbsp;AGREGAR EQUIPO-INVENTARIO</b></td>
				...
				<tr>
					<td>
						...
						<table style="color:#000000" cellpadding="5">
                        	...
                        	<tr><td>Cantidad</td><td><input name="cantidad" onchange="solo_numeros(this)" onkeyup="solo_numeros(this)" style="width:50px;font-size:12px;" type="text" maxlength="255" /></td></tr>                                                            
						</table>
