<script language="javascript" type="text/javascript">
	...
	function editar()
	{
		...
		if(contador==1)
		{
			document.datagrid.action = "index.php?menu=8&accion=editar"
	...
	<tr>    
    	<td align="right">
        	<table border="0" width="100%" cellpadding="0" cellspacing="0" >
                ...
                <td align="left" background="imagenes/module_center.png" height="80" valign="middle" class="titulo"><b>&nbsp;&nbsp;CATALOGO TIPO DE STATUS</b></td>
                <td align="right" background="imagenes/module_center.png" height="80" >
                    <button class="boton2" onclick="location.href='index.php?menu=8&accion=agregar'" ><img src="imagenes/agregar.png" /><br/>Agregar</button>
		...
		if(isset($_POST['accion']))
		{
			switch($_POST['accion'])
			{
				case 'editar':
					...
					$query = "update tipo_status set descripcion='".addslashes(strtoupper($_POST['des']))."'  where id_tipo_status='".addslashes($_POST['id'])."'";
				...
				case 'agregar':
					...
					$query = "insert into tipo_status (id_tipo_status ,id_status, descripcion) values (0,'".addslashes(strtoupper($_POST['status']))."','".addslashes(strtoupper($_POST['des']))."')";
					if(mysqli_query($conexion,$query))
					{
						?>
							<tr>
				...
				case 'eliminar':
					foreach($_POST as $variable => $valor)
					{
						if($variable != "selector")
						{
							if($variable != "accion")
							{
								$query_eliminar = "DELETE FROM tipo_status WHERE id_tipo_status='".addslashes($variable)."'";
	...
	<tr>
		<td colspan="3">
			...
			<table class="datagrid" width="100%" border="0" cellspacing="0">
				<tr><td colspan="3" height="3px" class="separador"></td></tr>
				...
				<?php
					$query = "select t.id_tipo_status,
					(SELECT descripcion from status where id_status=t.id_status),
					t.descripcion from tipo_status t";
					...
					while($registro=mysqli_fetch_array($tabla))
					{
						...
						?>
							<tr class="tabla_row">
								<td><a href="index.php?menu=8&accion=editar&id=<?php echo $registro[0];  ?>"><?php echo $registro[2]; ?></a></td>
