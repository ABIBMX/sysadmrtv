<script language="javascript" type="text/javascript">
	...
	function editar()
	{
		...
		if(contador==1)
		{
			document.datagrid.action = "index.php?menu=19&accion=editar"
	...
	<tr>    
    	<td align="right">
        	<table border="0" width="100%" cellpadding="0" cellspacing="0" >
                ...
                <td width="70px" background="imagenes/module_center.png" height="80"  valign="middle"><img src="imagenes/sucursales.png" /></td>
                <td align="left" background="imagenes/module_center.png" height="80" valign="middle" class="titulo"><b>&nbsp;&nbsp;CALLES&nbsp;&nbsp;</b></td>
                <td align="right" background="imagenes/module_center.png" height="80" >
                    <button class="boton2" onclick="location.href='index.php?menu=19&accion=agregar'" ><img src="imagenes/agregar.png" /><br/>Agregar</button>
		...
		if(isset($_POST['accion']))
		{
			switch($_POST['accion'])
			{
				case 'editar':
					...
					$query = "update cat_calles set id_sucursal='".addslashes(strtoupper($_POST['sucursal']))."', nombre='".addslashes(strtoupper($_POST['nombre']))."'  where id_calle='".addslashes($_POST['id'])."'";
				...
				case 'agregar':
					...
					$query = "insert into cat_calles (id_calle,id_sucursal , nombre) values (0,'".addslashes(strtoupper($_POST['sucursal']))."','".addslashes(strtoupper($_POST['nombre']))."')";
					if(mysqli_query($conexion,$query))
					{
						?>
							<tr>
				...
				case 'eliminar':
					foreach($_POST as $variable => $valor)
					{
						if($variable != "selector")
						{
							if($variable != "accion")
							{
								$query_eliminar = "DELETE FROM cat_calles WHERE id_calle='".addslashes($variable)."'";
			...
			<table class="datagrid" width="100%" border="0" cellspacing="0">
				...
				<?php
					...
					while($registro=mysqli_fetch_array($tabla))
					{
						...
						?>
							<tr class="tabla_row">
								<td><a href="index.php?menu=19&accion=editar&id=<?php echo $registro[0];  ?>"><?php echo $registro[0]; ?></a></td>
