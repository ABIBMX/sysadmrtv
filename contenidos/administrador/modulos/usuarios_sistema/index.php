<script language="javascript" type="text/javascript">
	...
	function editar()
	{
		...
		if(contador==1)
		{
			document.datagrid.action = "index.php?menu=2&accion=editar"
	...
	function eliminar()
	{
		...
		{
			window.alert("No ha seleccionado ningun Usuario");
		}
	}
</script>
	...
	<tr>
    	...
    	<td align="right">
        	<table border="0" width="100%" cellpadding="0" cellspacing="0" >
                ...
                <td align="left" background="imagenes/module_center.png" height="80" valign="middle" class="titulo"><b>&nbsp;&nbsp;USUARIOS&nbsp;&nbsp;</b></td>
                <td align="right" background="imagenes/module_center.png" height="80" >
                    <button class="boton2" onclick="location.href='index.php?menu=2&accion=agregar'" ><img src="imagenes/agregar.png" /><br/>Agregar</button>
		...
		if(isset($_POST['accion']))
		{
			switch($_POST['accion'])
			{
				case 'editar':
					...
					{
						$query_add = " , password='".addslashes($_POST['md5password'])."' ";
					}
					
					$query = "update usuario set id_usuario='".addslashes($_POST['id_usuario'])."', id_empleado='".addslashes($_POST['id_empleado'])."', id_tipo_usuario=".addslashes($_POST['tipo_usuario'])." ".$query_add." where id_usuario='".addslashes($_POST['id'])."'";
				...
				case 'agregar':
					$query = "insert into usuario (id_usuario,id_empleado , id_tipo_usuario, password) values ('".addslashes($_POST['id_usuario'])."','".addslashes($_POST['id_empleado'])."',".addslashes($_POST['tipo_usuario']).",'".addslashes($_POST['md5password'])."')";
					if(mysqli_query($conexion,$query))
					{
						?>                        	
							<tr>
				...
				case 'eliminar':
					foreach($_POST as $variable => $valor)
					{
						if($variable != "selector")
						{
							if($variable != "accion")
							{
								$query_eliminar = "DELETE FROM usuario WHERE id_usuario='".addslashes($variable)."'";
	...
	<tr>
		<td colspan="3">
			...
			<table class="datagrid" width="100%" border="0" cellspacing="0">
				...
				<?php
					$query = "select u.id_usuario,(select concat(nombre,' ',apellido_paterno,' ', apellido_materno) from empleados where id_empleado = u.id_empleado),tu.descripcion from usuario u, cat_tipo_usuario tu where u.id_tipo_usuario=tu.id_tipo_usuario";
					...
					while($registro=mysqli_fetch_array($tabla))
					{
						...
						?>
							<tr class="tabla_row">
								<td><a href="index.php?menu=2&accion=editar&id=<?php echo $registro[0];  ?>"><?php echo $registro[0]; ?></a></td>
