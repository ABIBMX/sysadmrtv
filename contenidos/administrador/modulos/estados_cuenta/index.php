					...
					<td>
						...
						<table style="color:#000000" cellpadding="5">
                        	<tr>
                            	<td>Sucursal</td>
                                <td>
                                	<select name="sucursal" onchange="if(this.value!='null'){document.formulario.id_cliente.value='';parametro_sucursal_cliente=this.value;}" style="width:300px; font-size:12px;">
                            ...
                            <tr><td>Clave del Cliente</td><td valign="middle"><input name="id_cliente" id="id_cliente" value="<?php echo $_POST['id_cliente']; ?>" readonly="readonly" style="width:110px;font-size:12px;" type="text" maxlength="12" />&nbsp;<img style="cursor:pointer;position:relative; top:4px;" onclick="if(document.formulario.sucursal.value!='null'){contenedor_cliente='id_cliente';createWindow('Buscar Cliente',450,310 ,1,false,true);}else{alert('Seleccione una sucursal');}" src="imagenes/popup.png" /></td></tr>
