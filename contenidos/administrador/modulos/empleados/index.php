	...
	<tr>    
    	<td align="right">
        	<table border="0" width="100%" cellpadding="0" cellspacing="0" >
                ...
                <button class="boton2" onclick="createWindow('Filtro',450,310 ,9,false,true);" ><img src="imagenes/filter.png" /><br/>Filtro</button>
		...
		if(isset($_POST['accion']))
		{
			switch($_POST['accion'])
			{
				case 'editar':
					...
					$query = "update empleados set nombre='".addslashes(strtoupper($_POST['nombre']))."',apellido_paterno='".addslashes(strtoupper($_POST['apat']))."',apellido_materno='".addslashes(strtoupper($_POST['amat']))."',clave='".addslashes(strtoupper($_POST['clave']))."',puesto='".addslashes(strtoupper($_POST['puesto']))."'  where id_empleado='".addslashes($_POST['id'])."'";
				...
				case 'agregar':
					...
					$empleado = "SELECT (max(substr(id_empleado,7)))+1 from empleados where id_empleado like 'E-".addslashes(strtoupper($_POST['sucursal']))."-%'";
				...
				case 'eliminar':
					foreach($_POST as $variable => $valor)
					{
						if($variable != "selector")
						{
							if($variable != "accion")
							{
								$query_eliminar = "DELETE FROM empleados WHERE id_empleado='".addslashes($variable)."'";
	...
	<tr>
		<td colspan="3">
			...
			<table class="datagrid" width="100%" border="0" cellspacing="0">
				...
				if($_POST['suc']!="null")
						{
							$add_query .= " and id_sucursal='".$_POST['suc']."' ";
						}
						...
						if($_POST['clave']!="")
						{
							$add_query .= " and clave like'%".addslashes($_POST['clave'])."%' ";
						}
						
						
					$query = "select id_empleado,(select nombre from sucursales where id_sucursal=em.id_sucursal),concat(nombre,' ',apellido_paterno,' ',apellido_materno),clave,puesto from empleados em where id_empleado!='null'".$add_query;
