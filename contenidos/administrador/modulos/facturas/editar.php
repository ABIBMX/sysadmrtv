...
<table border="0px"  width="100%" style="color:#000000;font-size:12px">
	<tr>    
    	<td align="right">
        	<table border="0" width="100%" cellpadding="0" cellspacing="0" >
                ...
                <td align="left" background="imagenes/module_center.png" height="80" valign="middle" class="titulo"><b>&nbsp;&nbsp;EDITAR FACTURA</b></td>
    ...
    <?php
		...
		if(isset($id))
		{
			$id_factura =  filter_var ($id, FILTER_SANITIZE_NUMBER_INT);
			...
			$query = "select
						...
						no_factura,
						id_canal
					 from f_facturas where id_factura=".$id;
			$registro = devolverValorQuery($query);
			if($registro[0]!='')
			{
				$fecha_pago_disabled = "disabled=\"disabled\"";
				if($registro[3] == "2" || $registro[14] == "2" || $registro[14] == "3"){
					$fecha_pago_disabled = "";
				}

				$iva_disabled = "disabled=\"disabled\"";
				if($registro[5]=="1")
					$iva_disabled = "";

				$tipo_cambio_disabled = "disabled=\"disabled\"";
				if($registro[4]!="1")
					$tipo_cambio_disabled = "";
	                        	  	...
	                        	  	<td colspan="3">
	                        	  		<div id="div_canal">
				                            <select name="canal" id="canal" style="width:350px;font-size:12px;">
				                        	   	...
				                        	   	<?php
													$query="select id_canal,nombre from f_canales where estado = 'Activo' AND id_proveedor=".$registro[1];
													$consulta=mysqli_query($conexion,$query);
													while(list($id,$sucursal)=mysqli_fetch_array($consulta)){
														if($registro[18]==$id)
															echo "<option selected=\"selected\" value='$id'>$sucursal</option>";
	                            ...
	                            <tr>
		                              ...
		                              <select name="tipo_factura" id="tipo_factura" style="width:150px;font-size:12px;">
		                              	...
		                              	<?php
											...
											while(list($id,$sucursal)=mysqli_fetch_array($consulta)){
												if($registro[3]==$id)
													echo "<option value='$id' selected=\"selected\">$sucursal</option>";
												else
													echo "<option value='$id'>$sucursal</option>";
											}
										?>
	                          	...
	                          	<tr>
	                        	  	<td>No. Factura:</td>
	                        	  	<td colspan="3"><input name="no_factura" style="width:350px;font-size:12px;" type="text" value="<?php echo $registro[17]; ?>" maxlength="50" /></td>
	                        	</tr>                 
	                        	<tr>
	                        	  	<td>Descripcion:</td>
	                        	  	<td colspan="3"><input name="descripcion" style="width:350px;font-size:12px;" type="text" value="<?php echo $registro[2]; ?>" maxlength="500" /></td>
	                        	</tr>    
	                          	<tr>
	                        	  	<td>Status:</td>
	                        	  	<td colspan="3">
	                          	...
	                          	<tr>
		                        	...
		                        	<td>
		                            	<input name="fecha_recepcion" id="fecha_recepcion"  value="<?php echo $registro[15]; ?>"  style="width:90px;font-size:12px; background-image:url(calendario/imgs/icon_minicalendar.gif); background-position:right center; background-repeat:no-repeat;" type="text" maxlength="10" readonly="readonly" />
		                            </td>
		                        </tr>
		                        <tr>
		                        	<td>Fecha de Pago:</td>
		                        	<td>
		                            	<input name="fecha_pago" id="fecha_pago" <?php echo $fecha_pago_disabled; ?>  value="<?php echo $registro[16]; ?>"  style="width:90px;font-size:12px; background-image:url(calendario/imgs/icon_minicalendar.gif); background-position:right center; background-repeat:no-repeat;" type="text" maxlength="10" readonly="readonly" />
		                            </td>
		                        </tr>
						...
						<td>
							...
							<table style="color:#000000" cellpadding="5">
	                          	...
	                          	<tr>
	                          		...
	                          		<td>VALOR IVA:</td>
	                          		<td><input name="valor_iva" id="valor_iva" class="decimal" value="<?php echo $registro[6]; ?>"  style="width:50px;font-size:12px; text-align:right;" type="text" maxlength="13" value="0.16" /></td>

	                          	</tr>
	                          	<tr>
	                        	  	<td>Subtotal:</td>
	                        	  	<td colspan="3">$ <input name="subtotal" id="subtotal" class="decimal" value="<?php echo $registro[7]; ?>" style="width:100px;font-size:12px;text-align:right;" type="text" maxlength="13" /></td>
	                        	</tr> 
	                        	<tr>
	                        	  	<td>IVA:</td>
	                        	  	<td >$ <input name="iva" id="iva" class="decimal" value="<?php echo $registro[8]; ?>" <?php echo $iva_disabled; ?> readOnly style="width:100px;font-size:12px;text-align:right;" type="text" maxlength="13" /></td>
	                        	...
	                        	<tr>
	                        	  	<td><b>Total:</b></td>
	                        	  	<td colspan="3">$ <input name="total" id="total" class="decimal" value="<?php echo $registro[9]; ?>" style="width:100px;font-size:12px;text-align:right;" type="text" maxlength="13" /></td>
	                        	</tr>
	                        	<tr>
	                        		<td height="10px"></td>
	                        	</tr>
	                        	<tr>
	                        	  	...
	                        	  	<td colspan="3">$ <input name="tipo_cambio" id="tipo_cambio" value="<?php echo $registro[10]; ?>" <?php echo $tipo_cambio_disabled; ?> class="decimal" style="width:100px;font-size:12px;text-align:right;" type="text" maxlength="13" /></td>
	                        	</tr>
	                        	<tr>
	                        	  	<td><b>Importe a Pagar:</b></td>
	                        	  	<td colspan="3">$ <input name="importe_pagar" id="importe_pagar" value="<?php echo $registro[11]; ?>" readOnly class="decimal" style="width:100px;font-size:12px;text-align:right;" type="text" maxlength="13" /> (Pesos Mexicanos)</td>
	                        	</tr>
	                        	
	                        	<tr>
	                        	  	<td>Total Pagado:</td>
	                        	  	<td colspan="3">$ <input name="total_pagado" id="total_pagado" class="decimal" value="<?php echo $registro[12]; ?>" style="width:100px;font-size:12px;text-align:right;" type="text" maxlength="13" /></td>
	                        	</tr>
	                        	<tr>
	                        	  	<td> <b>Saldo:</b> </td>
	                        	  	<td colspan="3">$ <input name="saldo" id="saldo" class="decimal" value="<?php echo $registro[13]; ?>" readOnly style="width:100px;font-size:12px;text-align:right;" type="text" maxlength="13" /></td>
	                        	</tr>    
