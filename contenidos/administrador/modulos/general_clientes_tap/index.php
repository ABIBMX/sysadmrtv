		...
		<td colspan="3">        	
			<table class="datagrid" width="100%" border="0" cellspacing="0">
				...
				<?php
					...
					$query = "select t.id_tap, t.valor, t.salidas, s.nombre, (select count(id_cliente) from clientes where id_tap=t.id_tap) from tap t, sucursales s where t.id_sucursal=s.id_sucursal ".$add_query." AND t.eliminado = 0 order by s.id_sucursal asc, t.id_tap asc";
