    						...
    						<td colspan="3">
    							<table class="datagrid" width="100%" border="0" cellspacing="0">
									...
									from clientes c where id_cliente='" . $registro[2] . "'";
												...
												<!-- preguntando si es cancelacion de tv + internet o internet , si ya fue recuperada la onu -->

												<tr>
    												<td>ONU Recuperada:</td>
    												<td>
    													<div id="nota">
    														<?php
															foreach ($lista as $valores) {
																if ($valores == 55 || $valores == 56) {

																	echo "<input type='hidden' name='bandera_onu_recuperada' value='1' />";

																	echo "<select name='onu_recuperada' style='width:300px; font-size:12px;'>";
																	...
																	echo "<input type='hidden' name='bandera_onu_recuperada' value='0' />";
																}
															}
															?>
    													</div>
															...
															if ($banderaInternet == 1 && $banderaNoInternet == 0 || $banderaInternet == 1 && $banderaNoInternet == 1) {
																...
																if (mysqli_num_rows($result) > 0) {
																	...
																	while ($resultado_datos = mysqli_fetch_array($result)) {
																		...
																		// echo "<td colspan='10' ><button onclick='guardarConfInternet()' style='background-color:#88DC65; width: 150px'>Guardar Información de la ONU</button></td>";
																...
																if (mysqli_num_rows($result) > 0) {
																	while ($resultado_datos = mysqli_fetch_array($result)) {
																		...
																		//echo "<td colspan='10' ><button onclick='guardarConfInternet2()' style='background-color:#88DC65; width: 150px'>Cerrar Configuracion de Internet</button></td>";
    				...
    				<script language="javascript">
    					...
    					function atender() {
    						...
    						if (banderaConf == 1) {
								...
								if(document.formulario.bandera_onu_recuperada.value == '1'){
									if(document.formulario.onu_recuperada.value == '0' || document.formulario.onu_recuperada.value == 'NO'){
										cadena += "\n No se puede cerrar el reporte si la ONU no fue recuperada";
									}
								}
    							if (cadena == "") {
    							...
    							<tr>
    								<td>
    									<table style="color:#000000" cellpadding="5">
    										...
    										<tr>
    											<td>Descripci&oacute;n de Atencion:</td>
    											<td style="max-width:300px"><?php echo $des_aten; ?></td>
    										</tr>
