...
<script language="javascript" type="text/javascript">
	...
	function guardar() {
		...
		if (document.formulario.descripcion_falla.value == '') {
			cadena += "\n Debe de ingresar una descripcion de la falla";
		}
	...
	function DatosInternet($servicio) {

		bandera_configuracion = false;
		var div_conf_internet = document.getElementById('datos_internet');
		if ($servicio != "null") {

			div_conf_internet.innerHTML = "<img src='imagenes/loading.gif' /> <span style='font-size:10px;'>Cargando ...</span>";
			var servicio = "servicio=" + $servicio;
			var cliente = "cliente=" + document.formulario.id_cliente.value;
			...
			$.ajax({
				...
				success: function(datos) {
					div_conf_internet.innerHTML = datos;
					bandera_configuracion = true;
				}
			});

		} else {
			div_conf_internet.innerHTML = "No Asignado";
		}
						...
						<form name="formulario" method="post" onsubmit="return false;" action="index.php?menu=18">
							<table style="color:#000000" cellpadding="5">
								...
								<tr>
									...
									<td><input name="fecha" style="width:200px;font-size:12px;" type="text" maxlength="255" value="<?php echo date("Y-m-d"); ?>" readonly="readonly" /></td>
								</tr>
							...
							<table class="datagrid" width="100%" border="0" cellspacing="0">
								...
								<tr>
									<td>
										<textarea name="descripcion_falla" cols="80" ></textarea>
