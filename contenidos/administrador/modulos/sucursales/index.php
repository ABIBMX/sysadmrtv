<script language="javascript" type="text/javascript">
	...
	function editar()
	{
		...
		if(contador==1)
		{
			document.datagrid.action = "index.php?menu=4&accion=editar"
	...
	<tr>    
    	<td align="right">
        	<table border="0" width="100%" cellpadding="0" cellspacing="0" >
                ...
                <td align="left" background="imagenes/module_center.png" height="80" valign="middle" class="titulo"><b>&nbsp;&nbsp;SUCURSALES&nbsp;&nbsp;</b></td>
                <td align="right" background="imagenes/module_center.png" height="80" >
                    <button class="boton2" onclick="location.href='index.php?menu=4&accion=agregar'" ><img src="imagenes/agregar.png" /><br/>Agregar</button>
		...
		if(isset($_POST['accion']))
		{
			switch($_POST['accion'])
			{
				case 'editar':
					...
					$query = "update sucursales set id_sucursal='".addslashes(strtoupper($_POST['clave']))."', nombre='".addslashes(strtoupper($_POST['nombre']))."'  where id_sucursal='".addslashes($_POST['id'])."'";
				...
				case 'agregar':
					...
					$query = "insert into sucursales (id_sucursal , nombre) values ('".addslashes(strtoupper($_POST['clave']))."','".addslashes(strtoupper($_POST['nombre']))."')";
					if(mysqli_query($conexion,$query))
					{
						?>
							<tr>
			...
			<table class="datagrid" width="100%" border="0" cellspacing="0">
				...
				<?php
					...
					while($registro=mysqli_fetch_array($tabla))
					{
						...
						?>
							<tr class="tabla_row">
								<td><a href="index.php?menu=4&accion=editar&id=<?php echo $registro[0];  ?>"><?php echo $registro[0]; ?></a></td>
