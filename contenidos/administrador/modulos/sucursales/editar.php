...
<table border="0px"  width="100%" style="color:#000000;font-size:12px">
	<tr>    
    	<td align="right">
        	<table border="0" width="100%" cellpadding="0" cellspacing="0" >
                ...
                <td align="left" background="imagenes/module_center.png" height="80" valign="middle" class="titulo"><b>&nbsp;&nbsp;EDITAR SUCURSAL&nbsp;&nbsp;</b></td>
                <td align="right" background="imagenes/module_center.png" height="80" >
                    <button class="boton2" id="guardar" onclick="guardar()" ><img src="imagenes/guardar.png" /><br/>Guardar</button>
					<button class="boton2" onclick="location.href='index.php?menu=4'"><img src="imagenes/cancelar.png" /><br />Cancelar</button>
                </td>
    ...
    <?php
		...
		if(isset($id))
		{
			...
			$query = "select * from sucursales where id_sucursal='".addslashes($id)."'";
	...
	<tr>
		<td colspan="3">
			<table class="datagrid" width="100%" border="0" cellspacing="0">
				...
				<tr>
					<td>						
						<form name="formulario" method="post" onsubmit="return false;"  action="index.php?menu=4">
						<table style="color:#000000" cellpadding="5">
                        	<tr><td>Clave</td><td><input name="clave" style="width:50px;font-size:12px;"  value="<?php echo $registro[0]; ?>" type="text" maxlength="3" /></td></tr>
                        	<tr><td>Nombre</td><td><input name="nombre" style="width:200px" type="text" maxlength="255" value="<?php echo $registro[1]; ?>" /></td></tr>                        </table>
