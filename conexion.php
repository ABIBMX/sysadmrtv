<?php
	$conexion = mysqli_connect(DB_SERVIDOR, DB_USUARIO, DB_PASSWORD, DB_NOMBRE,3306);
	if(!$conexion)
		die("<h3>ERROR al conectar a la base de datos</h3>");
	if(!mysqli_select_db($conexion,DB_NOMBRE))
		die("<h3>ERROR no se encuentra la base de datos</h3>");
	
	function devolverValorQuery($query)
	{
		global $conexion;
	...
	function cantidadRegistros($query)
	{
		global $conexion;
	...
	function historial($descripcion)
	{
		...
		$hora=  date("H:i:00");
		$fecha = date('Y-m-d');
		$query = "insert into historial values(0,'".$_SESSION['dartel_usuario']."','".$fecha."','".$hora."','".$descripcion."')";
		mysqli_query($conexion,$query);		
	}
	function transformarFechaDia($fecha)
	{
		$fecha= explode("-",$fecha);
		switch($fecha[0])
		{
			...
			case '3': $fecha[0]= "Mi�rcoles";break;
			case '4': $fecha[0]= "Jueves";break;
			case '5': $fecha[0]= "Viernes";break;
			case '6': $fecha[0]= "S�bado";break;						
			case '0': $fecha[0]= "Domingo";break;	
		}
		switch($fecha[2])
		{
			case '1': $fecha[2]= "enero";break;
			case '2': $fecha[2]= "febrero";break;
			case '3': $fecha[2]= "marzo";break;
			case '4': $fecha[2]= "abril";break;
			case '5': $fecha[2]= "mayo";break;
			case '6': $fecha[2]= "junio";break;						
			case '7': $fecha[2]= "julio";break;	
			case '8': $fecha[2]= "agosto";break;
			case '9': $fecha[2]= "septiembre";break;
			case '10': $fecha[2]= "octubre";break;
			case '11': $fecha[2]= "noviembre";break;
			case '12': $fecha[2]= "diciembre";break;
		}
		return $fecha[0]." ".$fecha[1]." de ".$fecha[2]." del ".$fecha[3];
	}
	...
	function transformarCantidadLetras($cantidad)
	{
		...
		for($i=0;$i<$total;$i++)
		{
			...
			if($enteros_array[$i]>1)
				...
				$anexo = $miles[$i][0];
			$numero_letras.= regresa_letras($enteros_array[$i],$centesimos).$anexo;
		}
	...
	function regresa_letras($numeros, $centesimo)
	{
						...
						switch((int)$enteros[$i])
						{
							...
							case 2:
									switch((int)$natural)
									{
										...
										case 4: $cadena_enteros.=" VEINTICUETO"; break;
