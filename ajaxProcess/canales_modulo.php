...
include("../conexion.php");
	...
	if(isset($_POST['id']))
	{
		...
		echo '<select name="canal" id="canal"   style="width:350px; font-size:12px;">
                <option value="-1">Seleccione un Canal</option>';
                
            $query_t_u = "select id_canal,nombre from f_canales where estado = 'Activo' AND id_proveedor=".$id;
